	        ...
	        <div class="container">
	        	<div class="row row-header">
					...
					<div class="navbar-header col-xs-12 col-sm-9 header-navbar" >
	            		<form class="form-inline" role ="search" action="home.php" method="GET">
			...
			<div class="row row-content">
				<div class="col-xs-12 col-sm-2 compose-button">
					...
					<ul class="nav nav-pills nav-stacked" style="margin-top:1em;">
						<li >
							<a href="MUDGAL_home.php" class="btn btn-primary">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<button type="submit" onclick="sendMail(this.form)" class="btn btn-primary">Send Mail</button>
										</div>
									</div>
								</form>
							</div>
				...
				<div class="col-xs-12 col-sm-6 primary content">
							...
							<?php
								if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_REQUEST['submit'])) {									
									...
									$query = "	SELECT 	u1.firstname AS from_user, u1.licenseID AS from_license,
												...
												WHERE 	u1.licenseID = '$from_user' AND u2.licenseID = 'license01'
												ORDER BY m.date;";
