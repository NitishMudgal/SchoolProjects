            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-4">
                    <a href="http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/">
                        <h1 class="text-capitalize">Smithsonian Migratory Bird Center</h1>
                    </a>
                </div>
            </div>            
        </div>
            ...
            <div class="row form-container">
                <form action="getBirdPicture" method="GET" class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="birdselect" class="col-sm-2">Select a bird to display:</label>
                        <div class="col-sm-4">
