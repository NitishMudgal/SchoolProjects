<%-- 
    Document   : result.jsp, result page
    Created on : Feb 3, 2016, 9:06:22 PM
    Author     : nmudgal
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="row row-header">
                <div class="col-sm-6 col-sm-offset-3">                    
                    <h3>Here is a picture of a <%= request.getAttribute("pictureTag")%> </h3>
                </div>
            </div>
            <div class="row row-content">
                <div class="col-sm-6 col-sm-offset-4">
                    <h4>&copy; <%= request.getAttribute("photographerName")%></h4>
                    <img src="<%= request.getAttribute("pictureURL")%>">
                </div>
            </div>
            <div class="row form-container">
                    <form action="getBirdPicture" method="GET" class="form-horizontal" role="form">
                        <div class="form-group">
                            <label for="birdselect" class="col-xs-12 col-sm-3">Select another bird to display:</label>
                            <div class="col-xs-12 col-sm-4">
                                <!-- Source: http://nationalzoo.si.edu/scbi/migratorybirds/featured_photo/ -->
                                <select class="form-control" name="birdname" id="birdname">               
